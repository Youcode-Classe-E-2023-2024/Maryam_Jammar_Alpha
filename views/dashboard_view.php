...
<aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
    <div class="h-19">
        ...
        <a class="text-center block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700" href="">
<!--            <img src="./assets/img/xeno.png" class="inline h-full max-w-full transition-all duration-200 dark:hidden ease-nav-brand max-h-8" alt="main_logo" />-->
        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="index.php?page=products">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <i class="relative top-0 text-sm leading-normal text-cyan-500 ni ni-calendar-grid-58"></i>
                    </div>
...
<main class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-68 rounded-xl">
                                    ...
                                    <div class="flex py-1">
                                        <div class="inline-flex items-center justify-center my-auto mr-4 text-sm text-white transition-all duration-200 ease-nav-brand bg-gradient-to-tl from-slate-600 to-slate-300 h-9 w-9 rounded-xl">
                                            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                ...
                                                <i class="ni ni-cart items-center"></i>
                                            </svg>
                                        </div>
                                        <div class="flex flex-col justify-center">
                                            <h6 class="mb-1 text-sm font-normal leading-normal dark:text-white">Product successfully added</h6>
                                        </div>
                                    </div>
                                </a>
                            </li>
    ...
    <div class="w-full px-6 py-6 mx-auto" id="yourElementId">
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
            <!--products list-->
            <div class="w-full h-5/6 max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
                <div class="border-black/12.5 shadow-3xl dark:bg-slate-850 dark:shadow-dark-xl relative flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                    <div class="p-4 pb-0 rounded-t-4 mb-4">
                        <h6 class="mb-0 dark:text-white">Products</h6>
                    </div>
                    <div class="flex-auto p-4">
                        <ul class="flex flex-col mb-0 rounded-lg">
                            <li class="relative flex justify-between  mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                                <div class="flex flex-col" id="productList">

                                </div>
                            </li>
                            <!-- Add more list items for other product details -->
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <!--pie-->
            <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none shadow-xl">
                <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                    <!-- slide 1 -->
                    <div class="col-span-12 rounded-sm bg-white px-5 pt-7.5 pb-5 dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-5">
                        ...
                        <div class="mb-2">
                            <div id="chartFour" class="mx-auto flex justify-center p-6" style="min-height: 295.367px;"></div>
                        </div>
                            ...
                            <div class="w-full px-8 sm:w-1/2">
                                <div class="flex w-full items-center">
                                    ...
                                    <p class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
                                        <span> Product </span>
                                        <span class="product-percentage"> Loading... </span>
                                    </p>
                                </div>
                            </div>
                            <div class="w-full px-8 sm:w-1/2">
                                <div class="flex w-full items-center">
                                    ...
                                    <p class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
                                        <span> Users </span>
                                        <span class="users-percentage"> Loading... </span>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <!--graph bar-->
        <div class="mt-4 w-full h-5/6 max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none shadow-3xl">
